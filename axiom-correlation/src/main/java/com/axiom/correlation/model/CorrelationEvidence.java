...
/**
 * A normalized input observation from one of three independent sources, collected before any
...
public sealed interface CorrelationEvidence
        permits TestFailureEvidence, SourceChangeEvidence, ExecutionEvidence {
